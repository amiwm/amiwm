...
static Bool
is_inside(int x0, int y0, int w, int h, int x, int y)
{
  if (w == 0 || h == 0)
...
static enum click
got_clicked(Client *c, Window w, Cursor curs, Time time)
{
...
void
click_close(Client *c, Time time)
{
...
void
click_depth(Client *c, Time time)
{
...
void
click_iconify(Client *c, Time time)
{
